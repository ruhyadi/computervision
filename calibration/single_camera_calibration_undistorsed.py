...
import glob
import argparse
from calibration_store import save_coefficients, save_kitti
...
if __name__ == '__main__':
    ...
    ret, mtx, dist, rvecs, tvecs, total_error = calibrate(args.image_dir, args.prefix, args.image_format, args.square_size, args.width, args.height)
    save_coefficients(mtx, dist, args.save_file)

    # undistorsed image
    img = cv2.imread('data/images_03/000000.png')
    h,  w = img.shape[:2]
    newcameramtx, roi = cv2.getOptimalNewCameraMatrix(mtx, dist, (w,h), 1, (w,h))

    #save_kitti(mtx, args.save_file)
