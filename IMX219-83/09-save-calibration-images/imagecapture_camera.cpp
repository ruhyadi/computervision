...
int main(int, char**)
{
    ...
    for (;;)
    {
        ...
        if (key == 's')
        {    
            sprintf(file_dst[0], "/home/gamanet/Capstone/IMX219-83/09-save-calibration-images/images/left%d.jpg", idx);
            sprintf(file_dst[1], "/home/gamanet/Capstone/IMX219-83/09-save-calibration-images/images/right%d.jpg", idx);
